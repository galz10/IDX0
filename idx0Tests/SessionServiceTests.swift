...
final class SessionServiceTests: XCTestCase {
  ...
  func testSchema1SessionsMigrateIntoProjectGroups() throws {
    let root = FileManager.default.temporaryDirectory
  ...
  func testSchema1SessionsWithSameRepoMigrateIntoSingleGroup() throws {
    let root = FileManager.default.temporaryDirectory
  ...
  func assertHasSingleTrailingEmptyWorkspace(
    ...
    let trailingEmptyCount = layout.workspaces.suffix(1).count(where: { $0.columns.isEmpty })
